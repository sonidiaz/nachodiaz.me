...
const TRAYECTORIA = [
  { year: "2023→",    empresa: "RTVE.es",        rol: "Senior Frontend Engineer · Plataforma editorial nacional" },
  { year: "2020→23",  empresa: "BeForGet",        rol: "Frontend Engineer · Plataforma EdTech y comunidad" },
      ...
      <section className={styles.section} id="sobre">
        <div className={styles.inner}>
          <div className="reveal">
            ...
            <h2 className={styles.titulo}>Nacho Díaz</h2>

            <p className={styles.p}>
              Soy frontend engineer con más de diez años construyendo productos digitales —
            ...
            <p className={styles.p}>
              ...
              mi productividad desde que empecé a programar. Lo que antes me llevaba semanas, hoy
              lo entrego en días.
            </p>
            <p className={styles.p}>
