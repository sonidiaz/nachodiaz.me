...
export const PROYECTOS: Proyecto[] = [
  ...
  },
  {
    ...
    cliente: "RTVE.es",
    descripcion: "Backend en PHP que actúa como API y panel de administración de datos: transforma hojas de cálculo de Google Sheets en JSON servido públicamente, con un dashboard para regenerar y monitorizar cachés y un panel para gestionar las fuentes de datos sin tocar código.",
